...
- **`create-cli` v3.0.2** — Fully rewritten for npm publish:
...
- **3.0.2** (2026-05-25) - Auth Middleware, Cache, Rate Limiting, Health Check, Socket JWT Auth, DB Transactions, Env Validation, Docker, create-cli v3.0.2
